...
h_deb, m_deb = heure_vers_int(float(evaluation[3]))
h_fin, m_fin = heure_vers_int(float(evaluation[4]))
print(f"La prochaine évaluation sera : {evaluation[5]} le {jour_semaine(date)} {date[2]:02d}/{date[1]:02d}/{date[0]:04d} de {h_deb:02d}h{m_deb:02d} à {h_fin:02d}h{m_fin:02d}")
